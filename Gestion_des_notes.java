...
tble.setModel(model);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(435, 183, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String requete="insert into etudient(id,Nom,Prenom,branche,note)VALUES('"+id+"','"+nom+"','"+prenom+"',"
               + "'"+branche+"'"  + ",'"+note+"')";
       try{stm.executeUpdate(requete);
...
afficher();
   ...
   afficher()   ;    
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
       try {
             if(JOptionPane.showConfirmDialog(null,"attention vous allez supprimer un etudient,est ce que tu est sure?"
